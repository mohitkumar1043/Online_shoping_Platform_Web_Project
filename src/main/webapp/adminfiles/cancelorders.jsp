...
<!-- this jsp page calling after cliking by admin on cancel orders  link -->
...
<table id="customers">
     ...
     try{
    	 ...
    	 String query="select * from product inner join cart on product.id=cart.productid and cart.status='cancel' order by orderdate desc";
